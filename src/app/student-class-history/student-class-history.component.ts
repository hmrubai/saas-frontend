...
export class StudentClassHistoryComponent implements OnInit {
    ...
    getScheduleList() {
        ...
        this._service.get('website/student-join-history/' + this.schedule_id).subscribe(res => {
